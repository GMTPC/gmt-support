import { hasInjectionContext, inject as inject$1, version as version$1, watch, onScopeDispose, reactive, computed, watchEffect, toRefs, isVNode, Comment, Fragment, shallowRef, warn, getCurrentInstance as getCurrentInstance$1, ref, unref, provide, defineComponent as defineComponent$1, toRaw, createVNode, mergeProps, readonly, isRef, toRef, Text, Transition, resolveDynamicComponent, withDirectives, defineAsyncComponent, h, shallowReactive, Suspense, nextTick, useSSRContext, resolveDirective, effectScope, capitalize, withCtx, TransitionGroup, vShow, createTextVNode, openBlock, createBlock, createCommentVNode, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, createElementBlock, createElementVNode } from 'vue';
import http from 'node:http';
import https from 'node:https';
import { a as destr, b as sanitizeStatusCode, c as createError$1, g as getRequestHeaders } from '../_/index.mjs';
...
import { ssrRenderComponent, ssrRenderStyle, ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const unhead_3FTgBWw22c = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./account-settings-BAU8HKV7.mjs')
  },
  {
    name: "cards",
    path: "/cards",
    component: () => import('./cards-BqvnoOGe.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-ccjI6lU5.mjs')
  },
  {
    name: "fix-assets-create",
    path: "/fix-assets/create",
    component: () => import('./create-r_CmCFNN.mjs')
  },
  {
    name: "fix-assets",
    path: "/fix-assets",
    component: () => import('./index-CD0rw8sD.mjs')
  },
  {
    name: "fix-assets-update-id",
    path: "/fix-assets/update/:id()",
    component: () => import('./_id_-qdf47I19.mjs')
  },
  {
    name: "form-layouts",
    path: "/form-layouts",
    component: () => import('./form-layouts-DXIczK6-.mjs')
  },
  {
    name: "icons",
    path: "/icons",
    component: () => import('./icons-CxoNbXL9.mjs')
  },
  {
    name: "it-service-request-create",
    path: "/it-service-request/create",
    component: () => import('./create-DjiCsQyq.mjs')
  },
  {
    name: "it-service-request",
    path: "/it-service-request",
    component: () => import('./index-B3npP65X.mjs')
  },
  {
    name: "it-service-request-update-id",
    path: "/it-service-request/update/:id()",
    component: () => import('./_id_-BSy0cbI5.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$5,
    component: () => import('./login-DbLzNeXe.mjs')
  },
  {
    name: "memo-id",
    path: "/memo/:id()",
    meta: __nuxt_page_meta$4,
    component: () => import('./_id_-CFOq_nbE.mjs')
  },
  {
    name: "memo-create",
    path: "/memo/create",
    meta: __nuxt_page_meta$3,
    component: () => import('./create-TMRSkDWn.mjs')
  },
  {
    name: "memo",
    path: "/memo",
    meta: __nuxt_page_meta$2,
    component: () => import('./index-ycs30KsU.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-C85wcGS4.mjs')
  },
  {
    name: "purchase-request",
    path: "/purchase-request",
    meta: __nuxt_page_meta$1,
    component: () => import('./purchase-request-DKI29g1-.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta,
    component: () => import('./register-BhFb6Dke.mjs')
  },
  {
    name: "report-ticket",
    path: "/report-ticket",
    component: () => import('./report-ticket-CH63Lvze.mjs')
  },
  {
    name: "tables",
    path: "/tables",
    component: () => import('./tables-CsmLk1ZM.mjs')
  },
  {
    name: "typography",
    path: "/typography",
    component: () => import('./typography-DeLffFsG.mjs')
  }
];
...
const revive_payload_server_L5yztrwtM8 = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_wy0B721ODc = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  ...
  unhead_3FTgBWw22c,
  plugin$1,
  revive_payload_server_L5yztrwtM8,
  plugin,
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-CD2OVkj9.mjs')),
  blank: defineAsyncComponent(() => import('./blank-DaZrbkd8.mjs')),
  "components-default-layout-with-vertical-nav": defineAsyncComponent(() => import('./DefaultLayoutWithVerticalNav-B-Snwdax.mjs')),
  "components-footer": defineAsyncComponent(() => import('./Footer-CU1sv2Bm.mjs')),
  "components-nav-items": defineAsyncComponent(() => import('./NavItems-DJ_kKkLO.mjs')),
  "components-navbar-theme-switcher": defineAsyncComponent(() => import('./NavbarThemeSwitcher-DPzEZk04.mjs')),
  "components-user-profile": defineAsyncComponent(() => import('./UserProfile-DpYlaKwg.mjs')),
  default: defineAsyncComponent(() => import('./default-C4nnFyA-.mjs')),
  project: defineAsyncComponent(() => import('./project-CUXfPphB.mjs'))
};
...
const UpgradeToPro = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-e7e49044"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    const props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "text-center" }, _attrs))} data-v-f08be041>`);
      if (props.statusCode) {
        _push(`<h1 class="header-title font-weight-medium mb-2" data-v-f08be041>${ssrInterpolate(props.statusCode)}</h1>`);
      } else {
        _push(`<!---->`);
      }
      if (props.title) {
        _push(`<h4 class="text-h4 font-weight-medium mb-2" data-v-f08be041>${ssrInterpolate(props.title)}</h4>`);
      } else {
        _push(`<!---->`);
      }
      if (props.description) {
        _push(`<p class="text-body-1 mb-6" data-v-f08be041>${ssrInterpolate(props.description)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f08be041"]]);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.14.1592_@parcel+watc_bad7dfef15c03f61e39cf02ac8a66502/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
const server = /*#__PURE__*/Object.freeze({
  ...
  A: VDefaultsProvider,
  B: makeBorderProps,
  C: makeDimensionProps,
  D: makeElevationProps,
  E: makeLoaderProps,
  F: makeLocationProps,
  G: makePositionProps,
  H: makeRoundedProps,
  ...
  a0: useSize,
  a1: EventProp,
  a2: makeTransitionProps,
  a3: wrapInArray,
  a4: getCurrentInstanceName,
  a5: consoleWarn,
  a6: getUid,
  a7: getCurrentInstance,
  a8: useToggleScope,
  a9: only,
  aA: focusChild,
  aB: isClickInsideElement,
  aC: getNextElement,
  aD: destructComputed,
  aE: parseAnchor,
  aF: flipSide,
  ...
  aL: useRouter,
  aM: useTheme,
  aN: VProgressCircular,
  aO: useRouter$1,
  aP: humanReadableFileSize,
  aQ: nuxtLinkDefaults,
  aR: resolveRouteObject,
  aS: navigateTo,
  aT: useNuxtApp,
  aU: useRuntimeConfig,
  aV: VProgressLinear,
  ...
  ao: createRange,
  ap: keyValues,
  aq: defineFunctionalComponent,
  ar: consoleError,
  as: getObjectValueByPath,
  at: isEmpty,
  au: makeDisplayProps,
  av: getPropertyFromItem,
  aw: useGoTo,
  ax: focusableChildren,
  ay: defineComponent,
  az: deprecate,
  b: useTextColor,
  c: useRender,
  d: makeComponentProps,
  default: entry$1,
  e: makeTagProps,
  f: makeThemeProps,
  g: genericComponent,
  ...
  o: omit,
  p: propsFactory,
  q: makeGroupItemProps,
  r: useGroupItem,
  s: convertToUnit,
  t: makeDensityProps,
  u: useRoute$1,
  v: useDensity,
  w: useBackgroundColor,
  x: provideDefaults,
  y: isObject,
  z: breakpoints
});

export { usePosition as $, useGroupItem as A, useDensity as B, useBackgroundColor as C, provideDefaults as D, convertToUnit as E, isObject as F, keys as G, useRouter$1 as H, IconValue as I, VProgressLinear as J, wrapInArray as K, humanReadableFileSize as L, MaybeTransition as M, filterInputAttrs as N, callEvent as O, makeDimensionProps as P, makeElevationProps as Q, makeLocationProps as R, makePositionProps as S, makeRoundedProps as T, makeVariantProps as U, VIcon as V, useVariant as W, useDimension as X, useElevation as Y, useLocation as Z, _export_sfc as _, VBtn as a, useNuxtApp as a$, useRounded as a0, genOverlays as a1, VDefaultsProvider as a2, useAuthStore as a3, navigateTo as a4, makeBorderProps as a5, useResizeObserver as a6, defineFunctionalComponent as a7, makeDisplayProps as a8, makeLoaderProps as a9, useLayout as aA, refElement as aB, Intersect as aC, only as aD, getCurrentInstanceName as aE, consoleWarn as aF, pick as aG, breakpoints as aH, defineComponent as aI, deprecate as aJ, focusChild as aK, isClickInsideElement as aL, getNextElement as aM, useRouter as aN, templateRef as aO, destructComputed as aP, parseAnchor as aQ, flipSide as aR, flipAlign as aS, flipCorner as aT, getAxis as aU, defer as aV, parseQuery as aW, nuxtLinkDefaults as aX, hasProtocol as aY, resolveRouteObject as aZ, joinURL as a_, useLoader as aa, LoaderSlot as ab, EventProp as ac, getObjectValueByPath as ad, isOn as ae, keyValues as af, getCurrentInstance as ag, deepEqual as ah, isEmpty as ai, getPropertyFromItem as aj, consoleError as ak, useToggleScope as al, makeTransitionProps as am, ensureValidVNode as an, debounce as ao, checkPrintable as ap, matchesSelector as aq, makeGroupProps as ar, makeRouterProps as as, Ripple as at, useBorder as au, useSize as av, useLink as aw, useGoTo as ax, focusableChildren as ay, VuetifyLayoutKey as az, makeDensityProps as b, useRuntimeConfig as b0, withTrailingSlash as b1, withoutTrailingSlash as b2, pickWithRest as b3, server as b4, makeSizeProps as c, makeTagProps as d, makeThemeProps as e, useLocale as f, genericComponent as g, provideTheme as h, useProxiedModel as i, clamp as j, createRange as k, getUid as l, makeComponentProps as m, useRender as n, VImg as o, propsFactory as p, useTheme as q, VProgressCircular as r, useDisplay as s, omit as t, useRoute$1 as u, makeVBtnProps as v, useTextColor as w, useRtl as x, useGroup as y, makeGroupItemProps as z };
