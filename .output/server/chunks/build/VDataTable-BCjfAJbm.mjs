import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, toRefs, ref, nextTick, watch, provide, inject, watchEffect, capitalize, unref } from 'vue';
import { p as propsFactory, I as IconValue, a5 as makeBorderProps, m as makeComponentProps, b as makeDensityProps, Q as makeElevationProps, T as makeRoundedProps, c as makeSizeProps, d as makeTagProps, e as makeThemeProps, U as makeVariantProps, g as genericComponent, i as useProxiedModel, f as useLocale, x as useRtl, h as provideTheme, s as useDisplay, D as provideDefaults, a6 as useResizeObserver, k as createRange, n as useRender, a as VBtn, a7 as defineFunctionalComponent, E as convertToUnit, a8 as makeDisplayProps, a9 as makeLoaderProps, aa as useLoader, C as useBackgroundColor, ab as LoaderSlot, ac as EventProp, ad as getObjectValueByPath, ae as isOn, af as keyValues, ag as getCurrentInstance, ah as deepEqual, K as wrapInArray, ai as isEmpty, V as VIcon, aj as getPropertyFromItem, j as clamp, ak as consoleError } from './server.mjs';
import { V as VSelect } from './VSelect-Cr6Di2uC.mjs';
import { V as VCheckboxBtn } from './VCheckboxBtn-DiqOHInw.mjs';
import { V as VChip } from './VChip-DBW6TD_X.mjs';
import { m as makeVTableProps, V as VTable } from './VTable-BXhkfgy8.mjs';
