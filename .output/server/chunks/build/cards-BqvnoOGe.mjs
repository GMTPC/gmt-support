...
import { computed, shallowRef, createVNode, Fragment, useSSRContext, mergeProps, createTextVNode, ref, withCtx, unref, isRef, toDisplayString, openBlock, createBlock, renderList, resolveComponent, withDirectives, vShow, createCommentVNode } from 'vue';
import { a as avatar1 } from './avatar-1-BLwzgS8N.mjs';
import { p as propsFactory, I as IconValue, m as makeComponentProps, b as makeDensityProps, c as makeSizeProps, d as makeTagProps, e as makeThemeProps, g as genericComponent, f as useLocale, h as provideTheme, i as useProxiedModel, j as clamp, k as createRange, l as getUid, n as useRender, a as VBtn, _ as _export_sfc, V as VIcon, o as VImg } from './server.mjs';
import { V as VExpandTransition } from './index-DUS45q6U.mjs';
import { V as VRow, a as VCol } from './VRow-zuLeAiTc.mjs';
import { V as VCard, b as VCardItem, c as VCardTitle, a as VCardText, d as VCardSubtitle, e as VCardActions } from './VCard-CSiTQXcr.mjs';
import { V as VAvatar } from './VAvatar-BWioJSAV.mjs';
import { V as VDivider } from './VDivider-LYYZi4vy.mjs';
import { V as VTabs, a as VTab, b as VWindow, c as VWindowItem } from './VTabs-D-jwyX0F.mjs';
                        ...
                        _push4(ssrRenderComponent(VCardText, { class: "position-relative" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<div class="d-flex justify-space-between flex-wrap pt-8" data-v-88f1fdee${_scopeId4}><div class="me-2 mb-2" data-v-88f1fdee${_scopeId4}>`);
                              ...
                              _push5(`</div><div class="d-flex justify-space-between align-center mt-4" data-v-88f1fdee${_scopeId4}><span class="font-weight-medium" data-v-88f1fdee${_scopeId4}>18 mutual friends</span><div class="v-avatar-group" data-v-88f1fdee${_scopeId4}><!--[-->`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VCardText, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="mb-4" data-v-88f1fdee${_scopeId4}> Although cards can support multiple actions, UI controls, and an overflow menu. </div>`);
                        ...
                        _push4(ssrRenderComponent(VExpandTransition, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div style="${ssrRenderStyle(unref(isCardDetailsVisible) ? null : { display: "none" })}" data-v-88f1fdee${_scopeId4}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCard, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row" data-v-88f1fdee${_scopeId3}><div class="ma-auto pa-5" data-v-88f1fdee${_scopeId3}>`);
                        _push4(ssrRenderComponent(VImg, {
                          width: "137",
                          height: "176",
                        ...
                        _push4(`<div data-v-88f1fdee${_scopeId3}>`);
                        _push4(ssrRenderComponent(VCardItem, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCardTitle, null, {
                        ...
                        _push4(ssrRenderComponent(VCardText, { class: "text-subtitle-1" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<span data-v-88f1fdee${_scopeId4}>Price :</span> <span class="font-weight-medium" data-v-88f1fdee${_scopeId4}>$899</span>`);
                            } else {
                              return [
                              ...
                              _push5(ssrRenderComponent(VBtn, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<span class="ms-2" data-v-88f1fdee${_scopeId5}>Add to cart</span>`);
                                  } else {
                                    return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCard, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="d-flex flex-column-reverse flex-md-row" data-v-88f1fdee${_scopeId3}><div data-v-88f1fdee${_scopeId3}>`);
                        _push4(ssrRenderComponent(VCardItem, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCardTitle, null, {
                        ...
                        _push4(ssrRenderComponent(VCardText, { class: "d-flex align-center flex-wrap text-body-1" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<span data-v-88f1fdee${_scopeId4}>5 Star | 98 reviews</span>`);
                            } else {
                              return [
                        ...
                        _push4(`</div><div class="ma-auto pa-5" data-v-88f1fdee${_scopeId3}>`);
                        _push4(ssrRenderComponent(VImg, {
                          width: 176,
                          src: unref(pages5),
                          class: "rounded"
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VCardText, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<p class="font-weight-medium text-base" data-v-88f1fdee${_scopeId4}> $249.40 </p><p class="mb-0" data-v-88f1fdee${_scopeId4}> 3.1GHz 6-core 10th-generation Intel Core i5 processor, Turbo Boost up to 4.5GHz </p>`);
                            } else {
                              return [
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(VCardText, { class: "d-flex justify-center" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="me-auto pe-4" data-v-88f1fdee${_scopeId6}><p class="d-flex align-center mb-6" data-v-88f1fdee${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VIcon, {
                                            color: "primary",
                                            icon: "bx-lock-open"
                                          }, null, _parent7, _scopeId6));
                                          _push7(`<span class="ms-3" data-v-88f1fdee${_scopeId6}>Full Access</span></p><p class="d-flex align-center mb-0" data-v-88f1fdee${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VIcon, {
                                            color: "primary",
                                            icon: "bx-user"
                                          }, null, _parent7, _scopeId6));
                                          _push7(`<span class="ms-3" data-v-88f1fdee${_scopeId6}>15 Members</span></p></div>`);
                                          ...
                                          _push7(`<div class="ms-auto ps-4" data-v-88f1fdee${_scopeId6}><p class="d-flex align-center mb-6" data-v-88f1fdee${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VIcon, {
                                            color: "primary",
                                            icon: "bx-star"
                                          }, null, _parent7, _scopeId6));
                                          _push7(`<span class="ms-3" data-v-88f1fdee${_scopeId6}>Access all Features</span></p><p class="d-flex align-center mb-0" data-v-88f1fdee${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VIcon, {
                                            color: "primary",
                                            icon: "bx-trending-up"
                                          }, null, _parent7, _scopeId6));
                                          _push7(`<span class="ms-3" data-v-88f1fdee${_scopeId6}>Lifetime Free Update</span></p></div>`);
                                        } else {
                                          return [
                              ...
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="membership-pricing d-flex flex-column align-center py-14 h-100 justify-center" data-v-88f1fdee${_scopeId5}><p class="mb-5" data-v-88f1fdee${_scopeId5}><sub class="text-h5" data-v-88f1fdee${_scopeId5}>$</sub><sup class="text-h2 font-weight-medium" data-v-88f1fdee${_scopeId5}>899</sup><sub class="text-h5" data-v-88f1fdee${_scopeId5}>USD</sub></p><p class="text-sm" data-v-88f1fdee${_scopeId5}> 5 Tips For Offshore <br data-v-88f1fdee${_scopeId5}> Software Development </p>`);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardText, { class: "d-flex align-center flex-wrap" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_ClientOnly, null, {}, _parent5, _scopeId4));
                              _push5(`<span class="text-subtitle-2" data-v-88f1fdee${_scopeId4}>5 Star | 98 reviews</span>`);
                            } else {
                              return [
                                createVNode(_component_ClientOnly, null, {
                                  default: withCtx(() => [
                        ...
                        _push4(ssrRenderComponent(VCardText, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<p data-v-88f1fdee${_scopeId4}> If you are looking for a new way to promote your business that won&#39;t cost you more money, maybe printing is one of the options you won&#39;t resist. </p><p class="mb-0" data-v-88f1fdee${_scopeId4}> become fast, easy and simple. If you want your promotional material to be an eye-catching </p>`);
                            } else {
                              return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardText, { class: "d-flex flex-column justify-center align-center" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<h6 class="text-h6" data-v-88f1fdee${_scopeId4}> Support </h6>`);
                            } else {
                              return [
                                createVNode(VAvatar, {
                                  color: "primary",
                        ...
                        _push4(ssrRenderComponent(VCardText, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<p data-v-88f1fdee${_scopeId4}> According to us blisters are a very common thing and we come across them very often in our daily lives. It is a very common occurrence like cold or fever depending upon your lifestyle. </p>`);
                            } else {
                              return [
...
const CardBasic = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-88f1fdee"]]);
