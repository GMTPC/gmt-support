import { reactive, ref, computed, toRef, watch, createVNode, Fragment, mergeProps, Teleport, withDirectives, vShow, resolveDirective, inject, watchEffect, nextTick, onScopeDispose, shallowRef, provide, toRaw, readonly, Transition } from 'vue';
import { a as animate, s as standardEasing, g as getTargetBox, B as Box, c as getOverflow, n as nullifyTransforms } from './forwardRefs-Oip3fNRq.mjs';
import { p as propsFactory, m as makeComponentProps, P as makeDimensionProps, e as makeThemeProps, am as makeTransitionProps, g as genericComponent, ag as getCurrentInstance, i as useProxiedModel, h as provideTheme, x as useRtl, C as useBackgroundColor, X as useDimension, aN as useRouter, al as useToggleScope, n as useRender, E as convertToUnit, M as MaybeTransition, aO as templateRef, aP as destructComputed, aQ as parseAnchor, aR as flipSide, aS as flipAlign, aT as flipCorner, aq as matchesSelector, ak as consoleError, aU as getAxis, j as clamp, aV as defer } from './server.mjs';
import { m as makeLazyProps, u as useLazy, a as useScopeId } from './scopeId-b3c5ZUEe.mjs';
...
export { VOverlay as V, VMenuSymbol as a, makeVOverlayProps as m };
