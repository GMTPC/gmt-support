import { createVNode, computed, withDirectives, vShow, ref, toRef, watch, mergeProps, Fragment, resolveDirective, cloneVNode, shallowRef, provide, markRaw, unref, nextTick, inject } from 'vue';
import { c as VSlideYTransition, a as VExpandXTransition } from './index-DUS45q6U.mjs';
import { p as propsFactory, ac as EventProp, m as makeComponentProps, e as makeThemeProps, g as genericComponent, n as useRender, am as makeTransitionProps, K as wrapInArray, w as useTextColor, M as MaybeTransition, I as IconValue, b as makeDensityProps, aD as only, P as makeDimensionProps, B as useDensity, X as useDimension, h as provideTheme, x as useRtl, l as getUid, a9 as makeLoaderProps, T as makeRoundedProps, aa as useLoader, a0 as useRounded, C as useBackgroundColor, E as convertToUnit, ab as LoaderSlot, a2 as VDefaultsProvider, aC as Intersect, i as useProxiedModel, N as filterInputAttrs, f as useLocale, aE as getCurrentInstanceName, aF as consoleWarn, ag as getCurrentInstance, al as useToggleScope, ae as isOn, aG as pick, O as callEvent, V as VIcon } from './server.mjs';
import { n as nullifyTransforms, a as animate, s as standardEasing, f as forwardRefs } from './forwardRefs-Oip3fNRq.mjs';
...
export { VTextField as V, makeVFieldProps as a, VInput as b, VField as c, VCounter as d, makeVTextFieldProps as e, filterFieldProps as f, useForm as g, VLabel as h, makeFormProps as i, createForm as j, makeVInputProps as m, useFocus as u };
