        ...
        <VCard class="card-form">
          ...
          <VCardText class="card-body">
            <VRow class="mb-4" align="center">
              ...
              <VCol cols="12" md="2">
                <VSelect v-model="statusFilter" :items="statusOptions" item-title="label" item-value="code"
                  label="สถานะ" />
              </VCol>
            ...
            <VDataTable v-else :items="filteredTickets" :headers="headers" class="my-data-table" density="comfortable"
              sticky>
